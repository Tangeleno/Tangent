...
-- @return Resulting value
Curves.step = function(x, threshold) return x < threshold and 0 or 1 end

--- Logarithmic curve
-- @param x Input value
-- @param base Logarithmic base (defaults to e)
-- @return Resulting value
Curves.logarithmic = function(x, base) return math.log(x + 1) / math.log(base or math.exp(1)) end

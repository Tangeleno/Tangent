...
local trees = {}
trees["sit"] =
'{ "inputs":{"name": "Root Node"}, "type": "SelectNode", "children": [ { "inputs":{"name": "Am sitting","conditionKey": "standing"}, "type": "ConditionNode" }, { "inputs":{"name": "Sit down"}, "type": "SitActionNode" } ] }'
trees["target"] =
